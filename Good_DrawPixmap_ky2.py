...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.img = cv2.imread(r'C:/Users\Admin\PythonLession\CarPlate\images\BSXe_tested/0144_00471_b.jpg')
        ...
        #self.pix = QPixmap(r'C:\Users\Admin\PythonLession\CarPlate\images\BSXe_tested\0144_00471_b.jpg')
    ...
    def paintEvent(self, event):
        if self.begin.x() != self.destination.x():
            ...
            painter = QPainter(self.uic.label_img.pixmap())
